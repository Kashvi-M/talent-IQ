    ...
    <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
        ...
        >
            ...
            <div className="flex flex-col">
                ...
                <span className="text-xs text-base-content/60 font-medium -mt-1">Code Together
                </span>
            </div>
        </Link>
        ...
        <SignInButton mode="modal">
            ...
            rounded-xl text-white front-semibold text-sm shadow-lg hover:shadow-xl transition-all
